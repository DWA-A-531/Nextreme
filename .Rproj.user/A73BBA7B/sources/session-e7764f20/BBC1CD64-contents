...
#' # Berechnung der Regenintensitaet-Dauer-Wiederkehrintervall Tabelle fuer 6 Wiederkehrintervalle (1,5,10,20,50 und 100 Jahren) und 12 Dauern (5, 10, 15,30,60,120,360,720,1440, 2880, 4320 und 10080 Minuten) auf der Grundlage der berechneten Parameter.
#' IDF_Tabelle = hN_Schaetzung(extrem.Parameter=extremParameter, Dauern=c(5, 10, 15,30,60,120,360,720,1440, 2880, 4320, 10080), Tn=c(1,5,10,20,50,100), methGEV="GEV", SerieTyp="INT")
#' # Berechnung der Regenhoehe-Dauer-Wiederkehrintervall Tabelle fuer 6 Wiederkehrintervalle (1,5,10,20,50 und 100 Jahren) und 8 Dauern (60,120,360,720,1440, 2880, 4320 und 10080 Minuten) auf der Grundlage der berechneten Parameter.
#' DDF_Tabelle = hN_Schaetzung(extrem.Parameter=extremParameter, Dauern=c(60,120,360,720,1440, 2880, 4320, 10080), Tn=c(1,5,10,20,50,100), methGEV="GEV", SerieTyp="VOL")
hN_Schaetzung = function(extrem.Parameter,
